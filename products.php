        ...
        <div class="row py-5">
            <div class="col-12 col-xl-12 mb-5 ">
                ...
                <div class="d-flex justify-content-end">
                    <button class="btn btn-info mb-3 me-3" type="button" data-bs-toggle="modal" data-bs-target="#closeButtonOutExample">
                ...
                <div class="scroll-div">
                    <div>
                        ...
                        ?>
                                <div class="card product-card mb-2" data-title="Product Card" data-intro="Here is a product card with buttons!" data-step="2">
                                    <div class="row g-0 sh-12">
                                        <div class="col-auto">
                                            <a>
                                                <img src="<?= ($val['productImage']) ? $val['productImage'] : 'uploads/defualt_products.png' ?>" alt="product image " class="card-img card-img-horizontal sw-13 sw-lg-15" style="max-height: 96px; width: 100px" />
                                            </a>
                                        </div>
                                        <div class="col">
                                            <div class="card-body pt-0 pb-0 h-100">
                                                <div class="row g-0 h-100 align-content-center">
                                                    <div class="col-12 col-md-7 d-flex justify-content-between mb-2 mb-md-0 position-static">
                                                        <span class="product-title"> Name:
                                                            <?php echo $val['name'] ?? '' ?>
                                                        </span>
                                                        <span class="product-title">Price:
                                                            <?php echo $val['price'] ?? 'Not Added' ?>
                                                        </span>
                                                    </div>
                                                    <div class="col-12 col-md-5 d-flex align-items-center justify-content-md-end">
                                                        <button data-product='<?= json_encode($val); ?>' class="btn btn-sm btn-icon btn-icon-start btn-outline-primary ms-1 edit-product" type="button" data-bs-toggle="modal" data-bs-target="#closeButtonOutExample">
                                                            <i data-acorn-icon="edit-square" data-acorn-size="15"></i>
                                                            <span class="d-none d-xxl-inline-block">Edit</span>
                                                        </button>
                                                        <button data-id="<?php echo $val['id'] ?? '' ?>" class="btn btn-sm btn-icon btn-icon-start btn-outline-primary delete-product ms-1" type="button">
                                                            <i data-acorn-icon="bin" data-acorn-size="15"></i>
                        ...
                        ?>
                        <div id="last_productCard" class="card mb-2 d-none " data-title="Product Card" data-intro="Here is a product card with buttons!" data-step="2">
                            <div class="row g-0 sh-12">
                                <div class="col">
                                    <div class="card-body pt-0 pb-0 h-100">
                                        <div class="row g-0 h-100 align-content-center">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabelCloseOut">Add Product</h5>
                    <button type="button" class="btn-close product-close-form" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="sw-lg-50 px-5">
                        <form id="product-details" action="products.php" method="POST" class="tooltip-end-bottom" enctype="multipart/form-data">
                            <div>
                                <div class="mb-3 tooltip-end-top">
                                    <div class="d-flex justify-content-center align-items-center mb-2 ">
                                        <img id="product-image-preview" src="uploads/defualt_products.png" alt="User Image" class="rounded-circle" style="height: 100px; width:100px">
                                    </div>
                                    <input id="product-image" required="" class="form-control" type="file" name="productImage" onchange="previewImage(this)">
                                    <input id="product-id" type="hidden" name="id">
                                </div>

                                <div class="mb-3 filled form-group tooltip-end-top">
                                    <input id="product-name" required="" class="form-control" placeholder="Name" name="name">
                                </div>

                                <div class="mb-3 filled form-group tooltip-end-top">
                                    <input id="product-price" required="" class="form-control" placeholder="Prices " name="price">
                                </div>

                                <div class="mb-3 filled form-group tooltip-end-top">
                                    <select id="select-category" style="border-color: black;" required="" class=" form-control" name="category_id">
                                        <option value=""> -- Select Category --</option>
                                        <?php foreach ($AllCategories as $key => $val) :
                                        ?>
                                            <option value="<?= $val['id'] ?>">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn product-close-form btn-secondary" data-bs-dismiss="modal">Close</button>
